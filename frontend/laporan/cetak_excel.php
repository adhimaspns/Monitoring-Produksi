<?php
  ...
  //! Select Data Laporan 
  $sqlLaporan   = "SELECT * FROM laporan_brg_keluar ORDER BY tgl_laporan DESC ";
      ...
      <div class="container margin-bottom-100">
        <center>
          ...
          <table border="1">
            ...
            <?php
              $no        = 1;
              $sqlNota   = "SELECT * FROM detail_transaksi INNER JOIN barang ON detail_transaksi.barang_id = barang.id_barang ORDER BY tgl_transaksi DESC";
