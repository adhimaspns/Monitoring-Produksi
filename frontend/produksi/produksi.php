										...
										<center>
											...
											<div id="myModal1" class="modal">
												...
												<div class="modal-content">
													...
													<form action="../../backend/temp/tambah_bahan.php?ket=bhn_baku&id_produksi=<?php echo $id_produksi ?>" method="POST">
									...
									<div class="table-box">
										<table class="table-responsive">
											...
											<tr>
												...
												<td><?= $temp['kategori'] ?></td>
												<td>
													<?= $temp['qty'] . " " . $temp['satuan'] ?>
													<a href="edit_qty.php?id_temp=<?php echo $temp['id_temp']?>&produksi_id=<?php echo $id_produksi ?>&bhn_id=<?php echo $temp['bhn_id']?>" class="lencana lencana-kuning">
												...
												<td>
													<a onclick="return confirm('Anda yakin ingin hapus item ?')" href="../../backend/temp/hapus_item_temp.php?id_temp=<?php echo $temp['id_temp']?>&bhn_id=<?php echo $temp['bhn_id']?>&produksi_id=<?php echo $id_produksi ?>" class="teks-merah">
