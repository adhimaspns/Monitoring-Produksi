		...
		<aside class="sidebar">
			<nav>
				<ul class="sidebar__nav">
					...
					<li>
						<a href="/Monitoring/frontend/bahan_baku/index.php?page=bahanbaku" class="sidebar__nav__link <?php if($_GET['page'] == 'bahanbaku'){  ?>sidebar-active <?php } ?>">
							<i class="fas fa-archive"></i>
							<span class="sidebar__nav__text">Bahan-Bahan</span>
						</a>
					</li>
					<li>
